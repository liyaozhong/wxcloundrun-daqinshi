...
def create_activity():
    ...
    try:
        activity = Activity(
            ...
            activity_time=datetime.strptime(data['activity_time'], '%H:%M').time() if data.get('activity_time') else None,
...
def list_activities():
    ...
    activities = [{
        ...
        'activity_time': item.activity_time.strftime('%H:%M') if item.activity_time else None,
    ...
    try:
        ...
        return jsonify({
            ...
            'data': {
                ...
                'activity_time': activity.activity_time.strftime('%H:%M') if activity.activity_time else None,
